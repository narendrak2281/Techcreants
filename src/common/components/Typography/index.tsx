  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        ...
        aria-level='1'
        className={cn(
          'text-3xl text-foreground font-heading text-center',
          className
        )}
        ref={ref}
        {...props}
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        ...
        aria-level='1'
        className={cn(
          ' font-body text-lg text-muted-foreground text-center ',
          className
        )}
        ref={ref}
        {...props}
  ...
  ({ className, asChild = false, ...props }, ref) => {
    ...
    return (
      <Component
        ...
        aria-level='1'
        className={cn(
          ' font-body text-lg text-foreground text-center ',
          className
        )}
        ref={ref}
        {...props}
...
H1.displayName = 'Subtitle';

const Heading = React.forwardRef<TextRef, SlottableTextProps>(
  ({ className, asChild = false, ...props }, ref) => {
    const Component = asChild ? Slot.Text : RNText;
    return (
      <Component
        ...
        aria-level='1'
        className={cn(
          ' font-bodyBold text-2xl text-foreground text-center ',
          className
        )}
        ref={ref}
        {...props}
...
export { BlockQuote, Code, H1, H2, H3, H4, Large, Lead, Muted, P, Small, Title, Subtitle, Body, Heading };